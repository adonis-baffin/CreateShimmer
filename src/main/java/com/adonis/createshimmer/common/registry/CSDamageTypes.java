...
public class CSDamageTypes {
    ...
    public static final DeferredRegister<DamageType> DAMAGE_TYPES =
            DeferredRegister.create(Registries.DAMAGE_TYPE, CSCommon.ID);

    // 定义我们自定义伤害类型的 ResourceKey
    public static final ResourceKey<DamageType> SHIMMER_MAGIC =
            ResourceKey.create(Registries.DAMAGE_TYPE, CSCommon.asResource("shimmer_magic"));
