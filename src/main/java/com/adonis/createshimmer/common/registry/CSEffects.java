...
public class CSEffects {
    public static final DeferredRegister<MobEffect> EFFECTS =
            DeferredRegister.create(Registries.MOB_EFFECT, CSCommon.ID);
    ...
    public static final DeferredHolder<MobEffect, MobEffect> SHIMMER_EFFECT =
            EFFECTS.register("shimmer", () -> new ShimmerEffect()
