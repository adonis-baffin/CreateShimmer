...
public final class ShimmerFluidType extends SolidRenderFluidType {
    private ShimmerFluidType(Properties properties, ResourceLocation stillTexture, ResourceLocation flowingTexture, int tintColor, Vector3f fogColor, Supplier<Float> fogDistanceModifier) {
    ...
    public static FluidTypeFactory create() {
        ...
        return (properties, stillTexture, flowingTexture) -> new ShimmerFluidType(properties,
                stillTexture,
                flowingTexture,
                tintColor,
                fogColor,
                ShimmerFluidType::getVisibility);
    }
    ...
    public void onVaporize(@Nullable Player player, Level level, BlockPos pos, FluidStack stack) {
        ...
        aoe.setOwner(player);
        aoe.setParticle(ParticleTypes.END_ROD); // Use end rod particles for shimmer effect
