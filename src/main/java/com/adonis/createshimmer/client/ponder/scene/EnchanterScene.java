...
public class EnchanterScene {
    public static void basic(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.world().modifyBlockEntity(util.grid().at(3, 1, 3), FluidTankBlockEntity.class,
                be -> be.getControllerBE().getTankInventory().fill(new FluidStack(CSFluids.EXPERIENCE.get(), 24000), IFluidHandler.FluidAction.EXECUTE));
        scene.idle(20);
        scene.world().modifyBlockEntity(util.grid().at(1, 1, 3), FluidTankBlockEntity.class,
                be -> be.getControllerBE().getTankInventory().fill(new FluidStack(CSFluids.EXPERIENCE.get(), 9000), IFluidHandler.FluidAction.EXECUTE));
        scene.idle(20);
        scene.world().modifyBlockEntity(util.grid().at(2, 1, 3), FluidTankBlockEntity.class,
                be -> be.getControllerBE().getTankInventory().fill(new FluidStack(CSFluids.EXPERIENCE.get(), 17000), IFluidHandler.FluidAction.EXECUTE));
        scene.idle(30);
        ...
        scene.overlay().showControls(util.vector().centerOf(2, 3, 1), Pointing.DOWN, 20).withItem(CSItems.ENCHANTING_TEMPLATE.asStack());
        scene.idle(100);
        scene.world().modifyBlockEntity(util.grid().at(2, 2, 1), BlazeEnchanterBlockEntity.class,
                be -> be.extractItem(true, false));
    ...
    public static void superEnchant(SceneBuilder builder, SceneBuildingUtil util) {
        ...
        scene.idle(10);
        scene.world().modifyBlockEntity(util.grid().at(2, 2, 1), BlazeEnchanterBlockEntity.class,
                be -> be.insertItem(CSItems.SUPER_ENCHANTING_TEMPLATE.asStack(), false));
        scene.overlay().showControls(util.vector().centerOf(2, 3, 1), Pointing.DOWN, 20).withItem(CSItems.SUPER_ENCHANTING_TEMPLATE.asStack());
        scene.idle(50);
        ...
        scene.world().modifyBlockEntity(util.grid().at(2, 2, 1), BlazeEnchanterBlockEntity.class,
                be -> {
                    ...
                    be.insertItem(CSItems.SUPER_ENCHANTING_TEMPLATE.asStack(), false);
                });
        scene.overlay().showControls(util.vector().of(2, 3, 1), Pointing.DOWN, 20).withItem(CSItems.SUPER_ENCHANTING_TEMPLATE.asStack());
        scene.idle(50);
        scene.world().createEntity(level -> {
            var lightning = EntityType.LIGHTNING_BOLT.create(level);
        ...
        scene.world().setBlock(util.grid().at(1, 1, 1), CSBlocks.SUPER_EXPERIENCE_BLOCK.getDefaultState(), false);
        scene.idle(20);
    }
